...
export default function OVRTONEPicColumn() {
    ...
    return(
        <div className="pt-8 lg:pt-24 order-1 lg:order-2">
            <Image className="max-w-[90%] sm:max-w-[66%] inline-block ml-4 mr-4 md:ml-28 lg:ml-64 lg:mr-64 mb-24" src={"https://api.deandivizio.com/wp-content/uploads/2024/08/OVRTONE1.webp"} width={2000} height={1000} alt="OVRTONE Media Group site " />
