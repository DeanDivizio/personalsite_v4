    ...
    return(
        <div>
            <Carousel opts={{ align: "center", loop: true, }} plugins={[plugin.current]}>
                <CarouselContent className="flex flex-row items-center max-h-[300px] sm:h-max-[500px]">
                    ...
                    <CarouselItem className="basis-2/3 sm:basis-2/3 sm:pl-16"><Image className="max-w-full" src={"https://api.deandivizio.com/wp-content/uploads/2024/08/Mohr_Newsletter_JAN23.webp"} width={612} height={792} alt={"Midwest Podiatry Centers newsletter design example"} /></CarouselItem>
