...
export default function OVRTONEPicColumn() {
    ...
    return(
        <div className="pt-24">
            <Image className="max-w-[66%] inline-block ml-64 mr-64 mb-24" src={"https://api.deandivizio.com/wp-content/uploads/2024/08/BarkPro1.webp"} width={2000} height={1000} alt="Bark Productions site " />
