  ...
  return (
    <html lang="en">
      <body className={inter.className}>
        ...
        {children}
        <div className="w-screen flex flex-row justify-center z-10 bottom-0 pb-2 pt-2 gap-2 bg-black text-xs font-extralight text-darkWhite">{`Copyright 2024 Dean Divizio`} <span>{`|`}</span><a className="transition underline hover:text-offWhite" href="mailto:contact@deandivizio.com">{`Contact Me`}</a></div>
        </body>
    </html>
  );
}
